...
public static class IntakeConstants {
  ...
  new Slot0Configs().withKP(1).withKI(0).withKD(0)
                    .withKA(0).withKS(0.).withKV(0);
...
public static class PivotConstants {
  ...
  public static final Slot0Configs GAINS = 
  new Slot0Configs().withKP(30).withKI(0).withKD(0.3)
                    .withKA(0).withKS(0.19).withKV(0)
                    .withKG(0.27).withGravityType(GravityTypeValue.Arm_Cosine);
...
public static class ElevatorConstants {
  ...
  public static final Slot0Configs GAINS = 
  new Slot0Configs().withKP(1).withKI(0.1).withKD(0.0)
                    .withKA(0).withKS(0).withKV(0)
                    .withKG(0.36).withGravityType(GravityTypeValue.Elevator_Static);
